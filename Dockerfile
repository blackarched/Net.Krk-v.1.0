...
COPY *.txt *.md *.yml *.toml *.json Dockerfile LICENSE /app/
...
# Default command
CMD ["gunicorn", "--bind", "0.0.0.0:5000", "--workers", "4", "--timeout", "120", "src.dashboard_api:app"]
...
CMD ["python3", "-m", "src.dashboard_api", "--demo-mode"]