...
from attacks import deauth_attack, capture_handshake, perform_evil_twin, run_external_tool
...
class TestAttacks(unittest.TestCase):
    ...
    @patch('attacks.shutil.which', return_value="/usr/bin/tool")
    ...
    @patch('attacks.run_external_tool')
